    ...
    <center>
      <q-item>
        <q-item-section align="center">
          <q-item-label class="text-h6 text-grey-9">Edit Photo</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-btn
            unelevated
      ...
      <div class="row">
        <div class="col-10">
          <div class="row q-mt-sm q-ml-sm">
            <div class="col-1">
              <q-item-label class="text-grey-9 text-body2">Zoom</q-item-label>
            </div>
            <div class="col-9"></div>
            <div class="col-1">
        ...
        <div class="col-1">
          <q-icon class="text-grey-9 q-mt-md" size="md" name="rotate_right" @click="rotateRight()" />
        </div>
      </div>
      <q-separator />
      <q-item align="center" style="margin-top:-6px;margin-bottom:-6px">
        ...
        <q-item-section>
          <q-btn
            ...
            flat
            size="lg"
            class="text-black q-ml-lg crop_save"
          />
        </q-item-section>
      </q-item>
    </center>
...
.crop_alert .custom-upload3 {
  ...
  margin-top: 0px;
  margin-left: 30px;
  background: url(../../statics/icons/upload.png);
...
export default {
  ...
  methods: {
    ...
    sendWidhtHeight()
    {
        // Passing between vue-cropper and CreateGroup
       let data = []
       data = this.$refs.cropper.sendWidhtHeight();
       return data
    },
    sendResult() {
      try {
